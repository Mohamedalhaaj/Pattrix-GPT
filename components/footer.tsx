  ...
  return (
    <footer id="contact" className="relative overflow-hidden bg-ink px-5 py-20 text-white sm:px-8 sm:py-28">
      ...
      <div className="relative mx-auto max-w-7xl">
        <Reveal>
          <p className="mb-8 text-xs font-semibold uppercase text-white/[0.48]">Contact</p>
        ...
        <div className="mt-14 grid gap-10 border-t border-white/[0.14] pt-9 lg:grid-cols-[0.8fr_1.2fr] lg:items-end">
          <Reveal>
            ...
            <div className="flex flex-wrap gap-3">
              {links.map((link) => (
                <Link
                  key={link}
                  href="#"
                  className="group inline-flex items-center gap-2 rounded-full border border-white/[0.14] px-4 py-3 text-sm text-white/70 transition duration-300 hover:border-white/[0.36] hover:text-white"
                >
                  {link}
                  <motion.span
                    whileHover={{ x: 3, y: -3 }}

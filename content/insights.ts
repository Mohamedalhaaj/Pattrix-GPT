...
export const insights: InsightArticle[] = [
  ...
  /* ------------------------------------------------------------------ */
  {
    ...
    counterpartPath: "/ar/insights/strategic-communications-libyan-institutions",
    ...
    langSwitch: {
      label: "اقرأ هذه الصفحة بالعربية",
      href: "/ar/insights/strategic-communications-libyan-institutions"
    },
    cta: {
      heading: "Let's make the next pattern.",
  ...
  /* ------------------------------------------------------------------ */
  /* AR — ماذا يعني الاتصال الاستراتيجي للمؤسسات الليبية                  */
  /* ------------------------------------------------------------------ */
  {
    slug: "strategic-communications-libyan-institutions",
    locale: "ar",
    path: "/ar/insights/strategic-communications-libyan-institutions",
    counterpartPath: "/insights/strategic-communications-libyan-institutions",
    title: "ماذا يعني الاتصال الاستراتيجي للمؤسسات الليبية؟ | باتريكس",
    metaDescription:
      "ماذا يعني الاتصال الاستراتيجي للمؤسسات الليبية: هندسة الرسائل، وترتيب القنوات، والانضباط الذي يحوّل النشر إلى استراتيجية.",
    ogTitle: "الاتصال الاستراتيجي للمؤسسات الليبية — باتريكس",
    ogDescription:
      "ما الذي يفصل الاتصال الاستراتيجي عن الدعاية الارتجالية: هندسة الرسائل، وترتيب القنوات، والاتساق تحت التدقيق.",
    eyebrow: "المقالات — الاتصال الاستراتيجي",
    h1: "ماذا يعني الاتصال الاستراتيجي للمؤسسات الليبية؟",
    ...
    sections: [
      {
        heading: "الدعاية تتفاعل، والاستراتيجية تقرر",
        paragraphs: [
      ...
      {
        heading: "هندسة الرسائل أولاً",
        bullets: [
          {
            title: "رسالة مركزية واحدة",
            text: "جملة واحدة تحتاج المؤسسة أن يحتفظ بها جمهورها. إن تعذّر قولها ببساطة، فلن يعوّض عنها أي قدر من النشر."
          },
          {
            title: "رسائل مشتقة لا موازية",
            text: "صيغ القنوات والجماهير تُشتق من الرسالة المركزية — ولا تُخترع إلى جوارها. هذا ما يمنع الانحراف بين ما تقوله القيادة وما تنشره الصفحات وما يظهر في التغطية."
          },
          {
            title: "لغة تحتمل المساءلة",
            text: "اللغة المؤسسية تُقتبس، وتُتداول لقطاتها، وتُواجه بها المؤسسة. كل جملة عامة ينبغي أن تُكتب وكأنها ستُقرأ على المؤسسة لاحقاً — لأن ذلك ما سيحدث."
          }
        ]
      },
      {
        heading: "ترتيب القنوات في ليبيا أهم من عددها",
        paragraphs: [
      ...
      {
        heading: "ماذا يشمل نظام الاتصال الاستراتيجي؟",
        bullets: [
          {
            title: "التموضع",
            text: "المكانة التي تحتلها المؤسسة في ذهن جمهورها، تُحدَّد قبل أي حملة — وما يميزها فعلاً عمّا سواها."
          },
          {
            title: "هندسة الرسائل",
            text: "الرسالة المركزية وصيغها المشتقة لكل قناة وجمهور، موثقةً بحيث ينهل كل من يتحدث باسم المؤسسة من المصدر نفسه."
          },
          {
            title: "تخطيط الجمهور والقنوات",
            text: "من يُخاطَب، وأين يعيش انتباهه فعلاً في السياق الليبي، وبأي ترتيب تحمل القنوات كل إعلان."
          },
          {
            title: "إيقاع نشر ثابت",
            text: "وتيرة منتظمة يمكن الاستمرار عليها — لا موجات حول الفعاليات يعقبها صمت. فالانتظام نفسه يوصل رسالة الاستقرار."
          },
          {
            title: "قياس واقعي",
            text: "مؤشرات يُتفق عليها قبل بدء العمل: هل تظهر الرسالة في التغطية، وما مدى اتساقها عبر القنوات، وما مدى ثبات السردية المؤسسية عبر الزمن."
          }
        ]
      },
      {
    ...
    relatedService: {
      label: "الاتصال الاستراتيجي في ليبيا",
      href: "/ar/services/strategic-communications-libya"
    },
    langSwitch: {
      label: "Read this page in English",
      href: "/insights/strategic-communications-libyan-institutions"
    },
    cta: {
      heading: "لنصنع النمط التالي.",
      text: "أخبرنا بما تحتاج مؤسستك أن يفهمه جمهورها، ونصمم نحن كيفية وصوله.",
      buttonLabel: "ابدأ مشروعاً"
    },
    breadcrumb: {
      home: "الرئيسية",
      hub: "المقالات",
      label: "الاتصال الاستراتيجي للمؤسسات الليبية"
    }
  },
  ...
  /* ------------------------------------------------------------------ */
  {
    ...
    counterpartPath: "/ar/insights/pr-vs-marketing-libya",
    ...
    langSwitch: {
      label: "اقرأ هذه الصفحة بالعربية",
      href: "/ar/insights/pr-vs-marketing-libya"
    },
    cta: {
      heading: "Let's make the next pattern.",
  ...
  /* ------------------------------------------------------------------ */
  /* AR — العلاقات العامة أم التسويق: ماذا تحتاج الشركات في ليبيا؟        */
  /* ------------------------------------------------------------------ */
  {
    slug: "pr-vs-marketing-libya",
    locale: "ar",
    path: "/ar/insights/pr-vs-marketing-libya",
    counterpartPath: "/insights/pr-vs-marketing-libya",
    title: "العلاقات العامة أم التسويق: ماذا تحتاج الشركات في ليبيا؟ | باتريكس",
    metaDescription:
      "العلاقات العامة تبني الثقة والتسويق يبني الطلب. دليل عملي يبيّن متى تحتاج الشركة في ليبيا إلى أحدهما، ومتى تحتاجهما معاً تحت استراتيجية واحدة.",
    ogTitle: "العلاقات العامة أم التسويق في ليبيا — باتريكس",
    ogDescription:
      "متى تحتاج الشركة في ليبيا إلى تنفيذ تسويقي، ومتى تحتاج إلى علاقات عامة، ومتى تحتاجهما معاً تحت استراتيجية واحدة — دليل قرار صادق.",
    eyebrow: "المقالات — دليل قرار",
    h1: "العلاقات العامة أم التسويق: ماذا تحتاج الشركات في ليبيا فعلاً؟",
    datePublished: "2026-08-07",
    intro:
    ...
    sections: [
      {
        heading: "عملان مختلفان، بكلام واضح",
        paragraphs: [
      ...
      {
        heading: "ثلاثة مواقف تواجهها الشركات في ليبيا فعلاً",
        bullets: [
          {
            title: "إطلاق منتج أو عرض",
            text: "هذا عمل تسويقي في معظمه: تحديد الجمهور، وبناء الحملة، وإنتاج المحتوى، والنشر بإيقاع منضبط. ولا تدخل العلاقات العامة إلا إذا كان الإطلاق يقول عن المؤسسة نفسها شيئاً يحتاج الجمهور إلى سماعه."
          },
          {
            title: "دخول السوق",
            text: "الشركة الجديدة، أو المنظمة الدولية القادمة إلى ليبيا، تحتاج أن تُفهم قبل أن يُروَّج لها. وذلك تموضعٌ وعلاقات عامة أولاً: من أنت، ولماذا أنت هنا، ولماذا تستحق كلمتك الثقة. أما الإنفاق التسويقي قبل وجود هذه الإجابة فغالباً ما يشتري وصولاً بلا معرفة."
          },
          {
            title: "لحظة تدقيق عام",
            text: "شكوى تنتشر على الإنترنت، أو نزاع يصبح علنياً، أو قرار يحتاج شرحاً — هذه أرض العلاقات العامة. رفع صوت التسويق خلالها يزيد الأمر سوءاً؛ ما تتطلبه اللحظة بيانٌ دقيق، ومتحدثٌ واضح، واتساقٌ إلى أن تتوقف الأسئلة."
          }
        ]
      },
      {
        heading: "دليل قرار مختصر",
        paragraphs: [
          "قبل اختيار وكالة، أجب عن أربعة أسئلة بصدق؛ فهي تخبرك أكثر مما يخبرك أي عرض تقديمي."
        ],
        bullets: [
          {
            title: "هل المشكلة في الطلب أم في الثقة؟",
            text: "إن كان الناس يعرفونك ويصدّقونك ولا يشترون، فأنت تحتاج إلى التسويق. وإن كانوا قد يشترون لكنهم يتردّدون في تصديقك — أو لا يعرفون ما الذي تمثله — فأنت تحتاج إلى العلاقات العامة أولاً."
          },
          {
            title: "كم يكلّف الخطأ العلني؟",
            text: "إن كانت كلمة خاطئة على الملأ تكلّف مكانة حقيقية — كما هو الحال للمؤسسات المالية ومقدمي الخدمات الصحية والمنظمات ذات الشركاء الدوليين — فأنت تحتاج إلى انضباط العلاقات العامة قبل إطلاق أي حملة."
          },
          {
            title: "ماذا ستقيس؟",
            text: "المبيعات والاستفسارات والإقبال في هذا الربع تشير إلى التسويق؛ واستقرار سمعتك عبر السنوات يشير إلى العلاقات العامة. كن صادقاً في تحديد الرقم الذي يعتمد عليه عملك فعلاً."
          },
          {
            title: "من الجمهور؟",
            text: "المستهلكون المفاضلون بين العروض جمهور تسويق؛ والإعلام والمؤسسات والشركاء والجهات الرقابية جمهور علاقات عامة. وأغلب الشركات الراسخة في ليبيا تخاطب الجمهورين معاً — وهنا تأتي أهمية الفقرة التالية."
          }
        ]
      },
      {
        heading: "لماذا تكون الإجابة الصادقة غالباً: كليهما — تحت استراتيجية واحدة",
        paragraphs: [
    ...
    relatedService: {
      label: "وكالة تسويق في طرابلس، ليبيا",
      href: "/ar/services/marketing-agency-tripoli"
    },
    langSwitch: {
      label: "Read this page in English",
      href: "/insights/pr-vs-marketing-libya"
    },
    cta: {
      heading: "لنصنع النمط التالي.",
      text: "أخبرنا بما يحتاجه عملك — الطلب أو الثقة أو كليهما — ونصمم نحن النظام الذي يحققه.",
      buttonLabel: "ابدأ مشروعاً"
    },
    breadcrumb: {
      home: "الرئيسية",
      hub: "المقالات",
      label: "العلاقات العامة أم التسويق في ليبيا"
    }
  },

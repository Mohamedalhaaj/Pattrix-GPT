  ...
  /* ------------------------------------------------------------------ */
  {
    ...
    sections: [
      ...
      },
      {
        ...
        paragraphs: [
          "الانضباط واحد وإن اختلفت الرهانات. متجر يعرض علامات نظارات فاخرة يحتاج ريلز تبيع دون أن تحطّ من قيمة ما على رفوفه — وهذا ما قام عليه عملنا مع بصريات طرابلس، حيث يلتقي التصوير المبني على المنتج بالإيقاع التحريري. وعلامة عالمية مثل هيونداي في ليبيا تحتاج مواد حملات تحمل الانضباط البصري نفسه الذي تحمله بيئاتها من صالة العرض إلى السوق.",
